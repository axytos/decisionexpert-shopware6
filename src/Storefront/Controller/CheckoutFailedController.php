...
namespace Axytos\DecisionExpert\Shopware\Storefront\Controller;
...
{
    const CHECKOUT_FAILED_VIEW = '@AxytosDecisionExpert/storefront/page/checkout/failed/index.html.twig';
